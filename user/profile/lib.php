...
class profile_field_base {
    ...
    public function is_editable() {
        ...
        // Custom Code Start
        // Is this a company manager and can they edit this user.
        if ((company::check_can_manage($this->userid) || empty($this->userid)) && iomad::has_capability('block/iomad_company_admin:user_edit', $systemcontext)) {
            return true;
        }
        // Custom Code End
        return false;
...
function profile_definition($mform, $userid = 0) {
    ...
    // Custom Code Start
    // Filter categories which only apply to this company.
...
function profile_get_signup_fields() {
    ...
    // Need to ignore profile fields which belong to another company.
