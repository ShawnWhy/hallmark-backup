 ...
 */
// Custom Code Start
// Note: db_should_replace was completely commented out.
// There is no change currently unless we comment it out.
// It is not done due to not being sure of the purpose.
...
function db_replace($search, $replace, $additionalskiptables = '') {
    ...
    // Custom Code Start
    // This is commented out due to not being sure of the purpose.
    // Everything in this block is custom. If commented out, does nothing.
    ...
    foreach ($tables as $table) {
        ...
        // Custom Code Start
        // This block is the old way of doing this.
        // If the above custom code is commented out, do not uncomment.
        // Old, and possibly outdated. Need to explore.
        ...
        if ($columns = $DB->get_columns($table)) {
            ...
            foreach ($columns as $column) {
                // Custom Code Start
                // If db_should_replace ends up needing to be removed,
                // this will be commented out as well. Otherwise, not custom yet.
