...
class completion_criteria_activity extends completion_criteria {
    ...
    public function cron() {
        ...
        // echo "<script>console.log('cronstart' );</script>";

        global $DB;
//CUSTOM CODE lines 235, 236 speeds up the query by limiting the range by timemodified to the more recent ones
        ...
        $sql = '
            ...
            WHERE
                mc.timemodified > (select max(cc2.timecompleted) - 60*30 from {course_completion_crit_compl} cc2)  and
                mc.timemodified > 1641422718 and 
