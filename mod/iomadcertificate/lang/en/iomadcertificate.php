...
$string['customtext'] = 'Custom Certificate Text (Name/Course/Date)';
$string['customtext_help'] = 'If you want to issue a historical certificate, enter the Name, then Course Name, then Date in this field, each on its own line. This will overwrite all three fields.';
$string['date'] = 'On';
...
$string['companydetails'] = 'has completed the course';
$string['companyscore'] = 'with an overall score of {$a}';
$string['companydate'] = 'on {$a}';
$string['companydatecap'] = 'On {$a}';

$string['companybottom'] = 'Certificate is valid from date of issue to the regulatory subject expiration date.';
$string['companysig1'] = 'Kenneth Wayne, Director of Training';
$string['companysig2'] = 'Hallmark Aviation';
$string['companysig3'] = 'Services';
